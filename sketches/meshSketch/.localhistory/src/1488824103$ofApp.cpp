...
void ofApp::update() {
	...
	_mesh.addIndices(new ofIndexType[3]{ 0, 1, 2 }, 3);
	_mesh.addIndices(new ofIndexType[3]{ 1,3,2 }, 3);
	_mesh.addIndices(new ofIndexType[3]{ 2,3,4 }, 3);
	_mesh.addIndices(new ofIndexType[3]{ 3,5,4 }, 3);
	_mesh.addIndices(new ofIndexType[3]{ 4,5,6 }, 3);
	_mesh.addIndices(new ofIndexType[3]{ 5,7,6 }, 3);
